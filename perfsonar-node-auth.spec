%define install_base /usr/lib/perfsonar/perfsonar-node-auth
...
%define apacheconf perfsonar-node-auth.conf

%define perfsonar_auto_version 4.1.6
%define perfsonar_auto_relnum 1

Name:			perfsonar-node-auth
...
Source0:		perfsonar-node-auth-%{version}.%{perfsonar_auto_relnum}.tar.gz
...
%prep
%setup -q -n perfsonar-node-auth-%{version}.%{perfsonar_auto_relnum}
